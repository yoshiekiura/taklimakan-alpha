...
echo "#########################################################" >> deploy
echo "" >> deploy
echo "if [ "\\$DB_HOST" = "" ]; then " >> deploy
echo "  echo \\"DB_HOST environment variable not set\\"" >> deploy
echo "  exit 1" >> deploy
echo "fi" >> deploy
echo "if [ "\\$DB_USER"  = "" ]; then " >> deploy
echo "  echo \\"DB_USER environment variable not set\\"" >> deploy
echo "  exit 1" >> deploy
echo "fi" >> deploy
echo "" >> deploy
